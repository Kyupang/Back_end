...
public class MZController {
	...
	//postmapping 으로 이제 파일 저장해!!! 
	//저장한 파일로 API 호출해 
	@PostMapping("/uploadFormAction")
	@ResponseBody 
	public MZInfoVO uploadFormPost(MultipartFile[] uploadFile) throws FileNotFoundException {
...
//		OCRGeneralAPI_old api = new OCRGeneralAPI_old();
